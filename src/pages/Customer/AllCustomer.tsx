...
const AllCustomer = () => {
 ...
 const storedClient = localStorage.getItem('client') ? JSON.parse(localStorage.getItem('client')) : null
 useEffect(()=>{
  if(storedClient){
    setClients([storedClient])
  }
    
 },[storedClient])


 console.log('ooooo', clients)
  return (
    <div>
      <h1>AllCustomer</h1>
